<template>
    ...
    <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div id="profile"
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                    <svg class="h-4 fill-current text-green-700 pr-4" viewBox="0 0 20 20"
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    <a class="link" data-tippy-content="@facebook_handle" href="#">
                    ...
                    <a class="link" data-tippy-content="@twitter_handle" href="#">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" data-tippy-content="@github_handle" href="#">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" data-tippy-content="@unsplash_handle" href="#">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                             xmlns="http://www.w3.org/2000/svg"><title>Unsplash</title>
                            <path d="M7.5 6.75V0h9v6.75h-9zm9 3.75H24V24H0V10.5h7.5v6.75h9V10.5z"/>
                        </svg>
                    </a>
                    <a class="link" data-tippy-content="@dribble_handle" href="#">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" data-tippy-content="@instagram_handle" href="#">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" data-tippy-content="@youtube_handle" href="#">
                        <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img"
                             viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>YouTube</title>
                            <path
        ...
        <div class="absolute top-0 right-0 h-12 w-18 p-4">
            <button class="js-change-theme focus:outline-none" @click="changeTheme()">🌙</button>
        </div>
